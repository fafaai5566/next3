...
import { projectsC } from './projectData';
import ProjectDetails from '../../components/ProjectDetails';
import ProjectCContent from './ProjectCContent';
...
export default function Id03Page() {
...
useEffect(() => {
  if (isMobile === false && projectsC.length > 0) {
    setSelectedProject(projectsC[0]);
  }
}, [isMobile]);
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col p-8 sm:p-10 space-y-6 justify-center max-w-7xl mx-auto">
      ...
      <div>
      <HeaderBar title="Fintech Experience" onBack={() => router.back()} />
        </div>
...
<ProjectLayout
      ...
      renderDetails={(project) => <ProjectCContent project={project} />}
    />
</div>
