...
import { projectsD } from './projectData';
import ProjectDetails from '../../components/ProjectDetails';
import ProjectDContent from './ProjectDContent';
...
export default function Id04Page() {
...
useEffect(() => {
  if (isMobile === false && projectsD.length > 0) {
    setSelectedProject(projectsD[0]);
  }
}, [isMobile]);
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col p-8 sm:p-10 space-y-6 justify-center max-w-7xl mx-auto">
      ...
      <div>
      <HeaderBar title="Learning System" onBack={() => router.back()} />
        </div>
...
<ProjectLayout
      ...
      renderDetails={(project) => <ProjectDContent project={project} />}
    />
</div>
