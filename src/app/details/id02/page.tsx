...
import { projectsB } from './projectData';
import ProjectDetails from '../../components/ProjectDetails';
import ProjectBContent from './ProjectBContent';
...
export default function Id02Page() {
...
useEffect(() => {
  if (isMobile === false && projectsB.length > 0) {
    setSelectedProject(projectsB[0]);
  }
}, [isMobile]);
...
<ProjectLayout
      ...
      renderDetails={(project) => <ProjectBContent project={project} />}
    />
</div>
