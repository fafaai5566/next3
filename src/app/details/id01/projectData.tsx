...
export const projectsA: ProjectData[] = [
    ...
    content: (
      <>
        ...
        {/* <hr className="border-neutralStroke mb-12" /> */}
          <div className="bg-neutralBg-level3 px-0 py-0 rounded-md mt-12 mb-16">
  <img
    src="/images/projects/entitymaster/entityMasterHeroImage.png"
    alt="Search results"
  ...
  />
      ...
      As part of a <strong>strategic partnership with Microsoft</strong>, I led the <strong>design direction</strong> and guided a junior designer in creating a modern platform for managing entity data.
        ...
        <MetricCluster
  items={[
    { title: "Visual modernaization", description: "Replaced a Windows 95-style legacy tool with the LSEG Halo design system" },
    { title: "Scalable design patterns", description: "Served as a pilot for design patterns that can be applied to other data tools." },
    { title: "Data platform foundation", description: "Set the foundation for future data tools across the LSEG ecosystem" },
    { title: "UX Maturity enhancement", description: "Enhanced project team's UX maturity from absence to emergent" },
  ]}
/>
</p>
...
<ArticleCluster>
      <ArticleSplit title="Misaligned collaboration">
        <ul className="list-disc pl-5 space-y-2">
          <li>Content team replicated the old system with minor visual tweaks.</li>
          <li>Wireframes were made in Excel and designers were asked to “paint over”.</li>
        </ul>
      </ArticleSplit>

      <ArticleSplit title="Gaps between requirements and user needs">
        <ul className="list-disc pl-5 space-y-2">
  ...
  <li>Designer-proposed improvements often <strong>disrupted delivery schedules</strong></li>
            ...
            <ArticleSplit title="Lack of cross-team alignment">
        <ul className="list-disc pl-5 space-y-2">
...
<ArticleCluster className="mt-8">


      <ArticleSplit title="Building a deeper understanding of users">
        <ul className="list-disc pl-5 space-y-2">
  ...
  <li>Insights directly <strong>informed design decisions</strong></li>
            ...
            <ArticleSplit title="Bridging stakeholders and designers">
        <ul className="list-disc pl-5 space-y-2">
  ...
  />
            ...
            <ArticleSplit title="Iterating the way of working">
        <ul className="list-disc pl-5 space-y-2">
  ...
  <li>Outcome: <strong>aligned</strong> the team, provided <strong>clear direction,</strong> and built <strong>momentum</strong></li>
            ...
            <ArticleSplit title="Rapid design iteration">
        <ul className="list-disc pl-5 space-y-2">
  ...
  <li>Presented to stakeholders → iterated → refined in <strong>fast cycles</strong></li>
        </ul>
          <img
...
This shift not only improved the product but also embedded <strong>UX thinking into the team’s culture</strong>.
  ...
  />
      ...
      <h2>Our Process</h2>
       ...
       <ArticleCluster className="mt-8 mb-8">
      <ArticleSplit title="1. Broadening the scope">
            <p>
      We persuaded the client to include user research as part of the assessment. In return, we committed to delivering both a research report and design audit report—not just technical estimates.
            ...
            <ArticleSplit title="2. Understanding the landscape">
             <p>
  ...
  <li>Where the platform disconnected and created friction for different types of users.</li>
      ...
      <ArticleSplit title="3. Identifying UX issues">
  ...
  />
      ...
      <ArticleSplit title="4. Moving from issues to solutions">
       <p>Rather than stopping at critique, we provided concrete design suggestions for how the platform could evolve—beyond just aesthetics—toward more efficient and user-centered workflows.</p> 
            ...
            <ArticleSplit title="5. Client validation">
...
<ul className="list-disc pl-6 space-y-2">
  ...
  <li>
    ...
    <MetricCluster
  items={[
    { title: "Eliminated redundancy"},
    { title: "Enhanced user experience" },
    { title: "Modern digital co-working space ready to compete in the market" },
